...
#define DT_BIND(x) std::bind(&x, this, std::placeholders::_1)
	...
	bool ImGuiLayer::OnEvent(IEvent& e)
	{
        ImGuiIO& io = ImGui::GetIO();

        EventDispatcher dispatcher(e);
        dispatcher.Dispatch<MouseMoveEvent>(DT_BIND(ImGuiLayer::OnMouseMove));
        dispatcher.Dispatch<MousePressEvent>(DT_BIND(ImGuiLayer::OnMousePress));
        dispatcher.Dispatch<MouseReleaseEvent>(DT_BIND(ImGuiLayer::OnMouseRelease));
